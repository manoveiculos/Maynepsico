-- ============================================================================
-- PATCH 22/02/2026 — Bloom Psicologia
-- INSTRUÇÕES: Copie TUDO → Supabase SQL Editor → RUN
-- SEGURO: pode rodar quantas vezes quiser
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_tasks_patient ON public.tasks_psico(patient_id);
CREATE INDEX IF NOT EXISTS idx_portal_access_code ON public.portal_access_psico(access_code);
CREATE INDEX IF NOT EXISTS idx_diagnostics_patient ON public.diagnostics_psico(patient_id);
CREATE INDEX IF NOT EXISTS idx_appointments_date ON public.appointments_psico(date);
CREATE INDEX IF NOT EXISTS idx_appointments_patient ON public.appointments_psico(patient_id);
CREATE INDEX IF NOT EXISTS idx_appointments_psychologist ON public.appointments_psico(psychologist_id);
CREATE INDEX IF NOT EXISTS idx_transactions_psychologist ON public.transactions_psico(psychologist_id);
CREATE INDEX IF NOT EXISTS idx_transactions_date ON public.transactions_psico(date);


-- ============================================================================
-- 3. MIGRAÇÃO SEGURA (colunas que podem faltar)
-- ============================================================================
...
-- ============================================================================
-- 4. TRIGGER: CRIAR PERFIL AUTOMÁTICO NO CADASTRO
-- ============================================================================
...
-- ============================================================================
-- 5. DESABILITAR RLS (MVP — mais seguro para não bloquear nada)
-- ============================================================================
-- Em produção futura, trocar por ENABLE + policies específicas
...
-- ============================================================================
-- ✅ PRONTO! Verifique:
-- • 10 tabelas criadas/atualizadas
-- • Índices de performance criados
-- • Trigger de perfil automático configurado
-- • RLS desabilitado (MVP)
-- • Conquistas iniciais inseridas
-- ============================================================================
